    function [newTruss,Stack] = processCMD(dummy,Truss,Stack)
        addpath('userinput\Truss\process\');
        addpath('userinput\Truss\Stack\');
        addpath('userinput\Truss\solveTruss\');
        addpath('userinput\Truss\system\');
        addpath('userinput\Truss\Image\');
        ...
        switch dummy(1)
            ...
            case "mkmem"
                ...
                switch err
                    ...
                    case "exist"
                        disp('이미 존재하는 부재입니다');
                    case "success"
                        Truss.A(end+1) = Default_A;
                        Truss.E(end+1) = Default_E;
            ...
            case "set"
                ...
                x1 = str2double(dummy(3));
                y1 = str2double(dummy(4));
                x2 = str2double(dummy(5));
                y2 = str2double(dummy(6));
                setVal = str2double(dummy(7));

                i1 = findnode(x1,y1,Truss);
                i2 = findnode(x2,y2,Truss);
